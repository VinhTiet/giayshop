<?php
    ...
    $sql_str = "select * from newscategory where id=$id";
    ...
    if(isset($_POST['btnUpdate'])) {
        ...
        $status = $_POST['status'];
        $sql_str = "update newscategory set name='$name', slug='$slug', status='$status' where id=$id";
                            ...
                            <form class="user" method="post" action="#">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" id="name" name="name"
                                        placeholder="Tên Danh Mục Tin Tức" value="<?=$cate['name']?>">
