...
<section class="related-blog spad">
    <div class="container">
        ...
        <div class="row">
            <?php
            $sql_str4 = "select * from news where newscategory_id=" . $row
            ["newscategory_id"] . " and id <> " . $row['id'];
            ...
            <div class="col-lg-4 col-md-4 col-sm-6">
                <div class="blog__item">
                    <div class="blog__item__pic">
                        <img src="<?= '../admincp/' . $row4['thumbnails'] ?>" alt="">
                    </div>
                    <div class="blog__item__text">
                        ...
                        <h5><a href="blogdetail.php?id=<?= $row4['id'] ?>"><?= $row4['title'] ?></a></h5>
                        <?= $row4['summary'] ?>
                    </div>
                </div>
            </div>
